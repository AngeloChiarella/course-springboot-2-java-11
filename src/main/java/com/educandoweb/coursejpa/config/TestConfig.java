...
import com.educandoweb.coursejpa.entities.Payment;
...
import com.educandoweb.coursejpa.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner //CommandLineRunner void run - executa a classe quando app e iniciada
{
	...
	public void run(String... args) throws Exception
	{
		...
		p1.getCategories().add(cat2);//Associação entre os objetos(Produto - Categoria)
		...
		o1.setPayment(pay1);//associar pedido 1 com pagamento 1
		orderRepository.save(o1);//salvando obj dependente OneToOne
